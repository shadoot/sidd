...
<div class="fa-lista-registro-actividad-deportiva-view">
    ...
    <p>
        <?= Html::a('Update', ['update', 'id' => $model->id_lista_registro_actividad_deportiva], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Delete', ['delete', 'id' => $model->id_lista_registro_actividad_deportiva], [
